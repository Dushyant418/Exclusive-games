...
import ellipse_33 from '../assets/Webp/Ellipse33.webp'
import {
  Accordion,
  AccordionHeader,
  AccordionBody,
...
const Accord = () => {
  ...
  return (
    <section className=" bg-[#00141B] relative">
      <div className="xl:max-w-[970px] mx-auto xl:px-3 container px-6 z-20">
        <h2
          className="md:text-[48px] font-Anton leading-[57.6px] font-[400] text-center pb-[60px] pt-[40px] md:pt-[150px] uppercase text-white text-[39px]"
        >
          Preguntas más frecuentes
        </h2>
        <div className=" flex justify-between flex-col ">
          <Accordion
            className=" border-[#80898D] border mb-[32px] rounded-[10px] py-4 px-5 z-10"
          ...
          <Accordion
            className=" border-[#80898D] border mb-[32px] rounded-[10px] py-4 px-5  overflow-hidden z-10"
          ...
          <Accordion
            className=" border-[#80898D] border rounded-[10px] py-4 px-5  z-10"
      ...
      <div className=" absolute top-[-400px] left-0 z-0 hidden lg:block">
        <img src={ellipse_33} alt="ellipse-img" />
      </div>
    </section>
  );
};
